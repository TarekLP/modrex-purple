...
- **`components/Sidebar.tsx`** — nav between Browse and Installed views. Has a collapse toggle at the bottom; collapsed state shrinks to `w-12` with single-letter abbreviations for nav items and `title` tooltips on hover.
