...
// The registry comes from Rust at runtime; stub api.listLoaders with the same shape
// LOADER_REGISTRY exports so the lookups can be tested without the backend.
const REGISTRY: LoaderInfo[] = [
    ...
    { id: 'ue4ss', modworkshopIds: [47749, 47771, 44048], games: ['cb', 'pd3'], viaModFlow: true },
]
...
describe('buildLoaderModIds', () => {
    ...
    it('spreads one UE4SS state across every page that distributes it', () => {
